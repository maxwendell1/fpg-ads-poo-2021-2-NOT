 ...
 */
@WebServlet(name = "MultiplicationTabelServlet", urlPatterns = {"/mult-table.html"})
public class MultiplicationTabelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                out.println("<table>");
                for(int i=1; i<=10; i++){
                    out.println("<th><th>"+n+"</th><th>x</th><th>"+i+"</th><th>=</th><th>"+(n*i)+"</td></tr>");
                }
            }catch(Exception ex){
